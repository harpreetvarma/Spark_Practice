...
public class Spark_Sql {
	...
	public static void main(String[] args) {
		...
		Dataset<Row> df = spark.read().option("header", "true").csv(
				"C:/harpreet/hadoop_and_spark/HDPCD-Certification-master/datasets/flightdelays/flight_delays1.csv");
		...
		// Dataset<Row> test =
		// sqlContext.jsonFile("C:/Users/Harpreet/Desktop/sfo_weather.csv");
		//
